...
/**
Unit tests for the MovieRemoteDataSourceImpl class.
 */
internal class MovieRemoteDataSourceImplTest : BaseApiTest(){
    ...
    /**
    Test case to verify successful mapping to the search model if the response is parsed successfully.
     */
    @Test
    ...
    /**
    Test case to verify successful mapping to the movie model if the response is parsed successfully.
     */
    @Test
    ...
    /**
    Test case to verify that an exception is propagated if it occurs when searching movies by keyword.
     */
    ...
    /**
    Test case to verify that an exception is propagated if it occurs when searching a movie by IMDb ID.
     */
    @Test(expected = HttpException::class)
    ...
    /**
    Test case to verify that a JsonDataException is unwrapped if it occurs when searching movies by keyword.
     */
    ...
    /**
    Test case to verify that a JsonDataException is unwrapped if it occurs when searching a movie by IMDb ID.
     */
    @Test(expected = UnexpectedException::class)
