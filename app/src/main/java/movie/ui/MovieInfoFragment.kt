...
import common.TAG_MOVIE_INFO_VIEWMODEL
import common.model.MovieType
import movie.assignment.R
import movie.assignment.databinding.FragmentMovieInfoBinding
import movie.item.NameItem
import movie.util.loadUri
import presentation.BaseViewModel
import presentation.DataState
import presentation.MovieInfoViewModel
import presentation.MovieInfoViewState
...
/**
A Fragment that displays information about a movie.
This Fragment is responsible for rendering the details and data of a movie, such as title, ratings,
plot, genres, directors, actors, and other relevant information.
 */
internal class MovieInfoFragment : Fragment() {
    ...
    Sets up the necessary UI components and observers to render the movie information.
     */
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            // Adjust the height of the plot container to match the height of the info container
